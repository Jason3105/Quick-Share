      ...
      <main className="min-h-screen bg-background flex items-center justify-center p-4">
        <div className="max-w-2xl w-full text-center space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center pt-4 px-4">
            <Button size="lg" onClick={() => router.push('/')} className="gap-2 w-full sm:w-auto sm:min-w-[200px]">
              <Home className="w-5 h-5" />
              Back to Home
            </Button>
            <Button size="lg" variant="outline" onClick={() => router.push('/send')} className="gap-2 w-full sm:w-auto sm:min-w-[200px]">
